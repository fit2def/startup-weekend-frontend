...
export default function LandingContent() {
    return (
        <div className="container">
            ...
            <div className="text-center container-wrap">
            ...
            <div className="row marketing text-center mt-4">
                <h2 className="featurette-heading"> Steps </h2>
                <div className="col-lg-3"> <div className="rounded-circle-container">
                    <img className="rounded-circle" src={phone} alt="stuff"></img></div>
                    <h3  className="top-image">Login or Create an Account</h3>
                    <p>It's free to sign up.</p>
                    <hr className="mb-4"></hr>
                </div>

                <div className="col-lg-3"> <div className="rounded-circle-container">
                    <img className="rounded-circle" src={shop} alt="stuff"></img></div>
                    <h3 className="top-image">Become a referrer</h3>
                ...
                <div className="col-lg-3"> <div className="rounded-circle-container">
                    <img className="rounded-circle" src={ladies} alt="stuff"></img></div>
                    <h3  className="top-image">Send the referral code</h3>
                ...
                <div className="col-lg-3"> <div className="rounded-circle-container">
                    <img className="rounded-circle" src={moneytime} alt="stuff" ></img></div>
                    <h3  className="top-image" >Get paid!</h3>
